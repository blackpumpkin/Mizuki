	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/2003338",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "GitHub",
					url: "https://github.com/blackpumpkin",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			name: "QQ",
			icon: "fa6-brands:qq",
			url: "https://qm.qq.com/cgi-bin/qm/qr?k=CZ01xdu9QvG6rlzxc3SirQkFXlIt0pv6&noverify=0&personal_qrcode_source=3",
		},
		{
			name: "steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/id/blackpumpkin13/",
		},
		{
			name: "email",
			icon: "mdi:envelope",
			url: "mailto:1450858504@qq.com",
		},
		{
			name: "RSS",
			icon: "mdi:rss",
