...
description: 有时从网上下载的音声没有翻译，我们可以用此方法解决燃眉之急。
tags: [音声,ACG]
category: 网络技巧
draft: false
pinned: false
...
# 三、在PotPlayer内添加其它的翻译器

> 众所周知，局域网想要连接诸如某G、某X等网站，我们是需要使用一些魔法手段的，所以此时PotPlayer内置的翻译器有时会很不好用。<br>
